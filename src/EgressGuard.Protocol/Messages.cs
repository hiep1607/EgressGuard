...
public static class MessageTypes
{
    ...
    public const string GetFileActivityHistory = "GetFileActivityHistory";
...
public sealed record FileActivityHistoryCursorMessage(DateTimeOffset ActivityTimestampUtc, Guid Id);
public sealed record GetFileActivityHistoryMessage(
    DateTimeOffset StartUtc,
    DateTimeOffset EndUtc,
    string? Search = null,
    FileActivityOperation? Operation = null,
    CorrelationConfidence? Confidence = null,
    int Limit = 100,
    FileActivityHistoryCursorMessage? Cursor = null);
public sealed record FileActivityHistoryMessage(
    DateTimeOffset StartUtc,
    DateTimeOffset EndUtc,
    IReadOnlyList<FileCorrelationHistoryItem> Items,
    bool HasMore,
    FileActivityHistoryCursorMessage? NextCursor,
    FileSensorStatus SensorStatus);
